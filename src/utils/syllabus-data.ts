...
export const EXAM_SYLLABI: SyllabusChapter[] = [
  ...
  // ── Accountancy ──
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Introduction to Accounting', sortOrder: 1 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Theory Base of Accounting', sortOrder: 2 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Recording of Transactions I', sortOrder: 3 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Recording of Transactions II', sortOrder: 4 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Bank Reconciliation Statement', sortOrder: 5 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Trial Balance and Rectification of Errors', sortOrder: 6 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Depreciation, Provisions and Reserves', sortOrder: 7 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Bills of Exchange', sortOrder: 8 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Financial Statements I', sortOrder: 9 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Financial Statements II', sortOrder: 10 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Accounting for Partnership Firms', sortOrder: 11 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Reconstitution of Partnership', sortOrder: 12 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Dissolution of Partnership Firm', sortOrder: 13 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Accounting for Share Capital', sortOrder: 14 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Financial Statements of Companies', sortOrder: 15 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Analysis of Financial Statements', sortOrder: 16 },
  { examType: 'CBSE_12', subject: 'Accountancy', chapter: 'Cash Flow Statement', sortOrder: 17 },
  // ── Business Studies ──
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Nature and Purpose of Business', sortOrder: 1 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Forms of Business Organisation', sortOrder: 2 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Private, Public and Global Enterprises', sortOrder: 3 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Business Services', sortOrder: 4 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Emerging Modes of Business', sortOrder: 5 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Social Responsibility of Business', sortOrder: 6 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Principles of Management', sortOrder: 7 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Functions of Management', sortOrder: 8 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Business Finance and Marketing', sortOrder: 9 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Marketing Management', sortOrder: 10 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Consumer Protection', sortOrder: 11 },
  { examType: 'CBSE_12', subject: 'Business Studies', chapter: 'Entrepreneurship Development', sortOrder: 12 },
  // ── Economics ──
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Introduction to Microeconomics', sortOrder: 1 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Consumer Behaviour and Demand', sortOrder: 2 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Producer Behaviour and Supply', sortOrder: 3 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Forms of Market and Price Determination', sortOrder: 4 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'National Income Accounting', sortOrder: 5 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Money and Banking', sortOrder: 6 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Determination of Income and Employment', sortOrder: 7 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Government Budget and the Economy', sortOrder: 8 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Balance of Payments', sortOrder: 9 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Indian Economy on the Eve of Independence', sortOrder: 10 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Indian Economy 1950-1990', sortOrder: 11 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Economic Reforms Since 1991', sortOrder: 12 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Poverty', sortOrder: 13 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Human Capital Formation in India', sortOrder: 14 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Rural Development in India', sortOrder: 15 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Employment and Unemployment', sortOrder: 16 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Infrastructure', sortOrder: 17 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Environment and Sustainable Development', sortOrder: 18 },
  { examType: 'CBSE_12', subject: 'Economics', chapter: 'Comparative Development Experiences', sortOrder: 19 },
  // ── Applied Mathematics ──
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Numbers, Quantification and Numerical Applications', sortOrder: 1 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Algebra', sortOrder: 2 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Sets and Relations', sortOrder: 3 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Calculus', sortOrder: 4 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Probability', sortOrder: 5 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Descriptive Statistics', sortOrder: 6 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Financial Mathematics', sortOrder: 7 },
  { examType: 'CBSE_12', subject: 'Applied Mathematics', chapter: 'Linear Programming', sortOrder: 8 },
  // ── English ──
